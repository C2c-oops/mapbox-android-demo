...
/**
 * See how which places of interest (POIs) are within a 30 min walk of two different peoples'
...
public class TwoPersonMeetupLocationIsochroneWithinActivity extends AppCompatActivity {
  ...
  private static final LatLng PERSON_ONE_STARTING_LAT_LNG = new LatLng(41.37932575, 2.17045283);
  private static final LatLng PERSON_TWO_STARTING_LAT_LNG = new LatLng(41.39003512, 2.17685586);
